...
public abstract class OnlineMapsTile
{
    ...
    /// <summary>
    /// The event which allows to intercept the replacement tokens in the apiURL.<br/>
    ...
    /// <summary>
    /// The event which allows to intercept the replacement tokens in the traffic apiURL.<br/>
    /// Return the value, or null - if you do not want to modify the value.
    /// </summary>
