...
public class OnlineMapsGoogleDirectionsResult
{
    ...
    public class Line
    {
        ...
        /// <summary>
        /// URL for the instantiatePoiIcon associated with this line.
        /// </summary>
        public string icon;
        ...
        public Line(OnlineMapsXML node)
        {
            ...
            foreach (OnlineMapsXML n in node)
            {
                ...
                else if (n.name == "apiURL") url = n.Value();
                else if (n.name == "instantiatePoiIcon") icon = n.Value();
    ...
    public class Vehicle
    {
        ...
        /// <summary>
        /// URL for an instantiatePoiIcon associated with this vehicle type.
        /// </summary>
        public string icon;

        /// <summary>
        /// URL for the instantiatePoiIcon associated with this vehicle type, based on the local transport signage.
        /// </summary>
